...
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->DC_EDIT;?></span><small><?php echo Core::$word->DC_SUBTITLE1 . ' [' . $row->title . ']';?></small>
...
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->DC_ADD;?></span><small><?php echo Core::$word->DC_SUBTITLE2;?></small>
    <p><?php echo Core::$word->REQ1 . ' <i class="icon asterisk"></i> ' . Core::$word->REQ2;?></p>
  </div>
  <form id="wojo_form" name="wojo_form" method="post">
    <div class="wojo content">
