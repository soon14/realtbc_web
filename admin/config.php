  ...
  <form id="wojo_form" name="wojo_form" method="post">
    <div class="wojo content">
      ...
      <div class="two fields">
        <div class="field">
          ...
          <div class="wojo left labeled icon input">
            ...
            <input type="hidden" value="<?php echo $core->site_dir;?>" name="site_dir">
        <div class="field">
      ...
      <div class="five fields">
        ...
        <div class="field">
          <label><?php echo Core::$word->CG_PAYPACK;?><i class="icon support" data-content="<?php echo Core::$word->CG_PAYPACK_T;?>"></i></label>
          <div class="inline-group">
            <label class="radio">
              <input name="paypack" type="radio" value="0" <?php echo getChecked($core->paypack, 0);?>>
              <i></i><?php echo Core::$word->YES;?></label>
            <label class="radio">
              <input name="paypack" type="radio" value="1" <?php echo getChecked($core->paypack, 1);?>>
              <i></i><?php echo Core::$word->NO;?></label>
          </div>
        </div>
      </div>
      ...
      <div class="four fields">
        ...
        <div class="field"></div>
            ...
            <input type="hidden" value="<?php echo $core->currency;?>" name="currency">
            <input type="hidden" value="<?php echo $core->cur_symbol;?>" name="cur_symbol">
            <input type="hidden" value="<?php echo $core->tsep;?>" name="tsep">
            <input type="hidden" value="<?php echo $core->dsep;?>" name="dsep">
      <div class="wojo fitted divider"></div>
      <div class="two fields">
        <div class="field">
