...
<div class="wojo breadcrumb"> <i class="icon home"></i> <a href="index.php" class="section"><?php echo Core::$word->N_DASH;?></a>
  ...
  <a href="index.php?do=memberships" class="section"><?php echo Core::$word->N_MEMS;?></a>
  <div class="divider"></div>
  <div class="active section"><?php echo Core::$word->MM_EDIT;?></div>
</div>
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->MM_EDIT;?></span><small><?php echo Core::$word->MM_SUBTITLE1 . ' [' . $row->title . ']';?></small>
    <p><?php echo Core::$word->REQ1 . ' <i class="icon asterisk"></i> ' . Core::$word->REQ2;?></p>
  </div>
        ...
        <div class="field">
          ...
          <div class="inline-group">
            ...
            <label class="radio">
              ...
              <input name="trial" type="hidden" value="0">
              <input name="recurring" type="hidden" value="0">   
...
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->MM_ADD;?></span><small><?php echo Core::$word->MM_SUBTITLE2;?></small>
    <p><?php echo Core::$word->REQ1 . ' <i class="icon asterisk"></i> ' . Core::$word->REQ2;?></p>
  </div>
  <form id="wojo_form" name="wojo_form" method="post">
    <div class="wojo content">
