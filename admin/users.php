...
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->UR_TITLE1;?></span><small><?php echo Core::$word->UR_SUBTITLE1 . ' [' . $row->username . ']';?></small>
    ...
    <div class="wojo content">
      ...
      <div class="two fields">
        <div class="field">
          ...
          <div class="wojo left labeled icon input">
            <input type="text" value="<?php echo $row->mem_expire;?>" name="mem_expire">
          </div>
        </div>
        <div class="field">
...
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->UR_TITLE2;?></span><small><?php echo Core::$word->UR_SUBTITLE2;?></small>
    <p><?php echo Core::$word->REQ1 . ' <i class="icon asterisk"></i> ' . Core::$word->REQ2;?></p>
  </div>
  <form id="wojo_form" name="wojo_form" method="post">
    <div class="wojo content">
    ...
    <div class="wojo basic segment">
      ...
      <div class="wojo project list">
        ...
        <div class="content">
          ...
          <div class="data"><?php echo $row->mem_expire;?></div>
        </div>
        <div class="content">
