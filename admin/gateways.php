...
<div class="wojo breadcrumb"> <i class="icon home"></i> <a href="index.php" class="section"><?php echo Core::$word->N_DASH;?></a>
  ...
  <a href="index.php?do=gateways" class="section"><?php echo Core::$word->N_GATE;?></a>
  <div class="divider"></div>
  <div class="active section"><?php echo Core::$word->GW_EDIT;?></div>
</div>
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->GW_EDIT;?></span><small><?php echo Core::$word->GW_SUBTITLE1 . ' [' . $row->displayname . ']';?> <a class="viewtip"><i class="icon question"></i></a></small>
