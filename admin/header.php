    ...
    <header>
      ...
      <nav class="clearfix">
        <ul>
          ...
          <li><a<?php if (Filter::$do == "templates" or Filter::$do == "news" or Filter::$do == "newsletter") echo ' class="active"';?>><?php echo Core::$word->N_CONTENT;?><i class="icon angle down"></i></a>
            <ul>
          ...
          <li><a<?php if (Filter::$do == "memberships" or Filter::$do == "gateways" or Filter::$do == "transactions" or Filter::$do == "coupons") echo ' class="active"';?>><?php echo Core::$word->MM_TITLE3;?><i class="icon angle down"></i></a>
            <ul>
              <li><a href="index.php?do=memberships"><?php echo Core::$word->MM_TITLE2;?></a></li>
          ...
          <li><a<?php if (Filter::$do == "config" or Filter::$do == "backup" or Filter::$do == "countries" or Filter::$do == "fields" or Filter::$do == "language") echo ' class="active"';?>><?php echo Core::$word->N_CONF;?><i class="icon angle down"></i></a>
            <ul>
