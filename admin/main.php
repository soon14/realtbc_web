...
<div class="wojo form basic segment">
  <div class="wojo header">
    ...
    <span><?php echo Core::$word->AD_TITLE;?> <?php echo $core->site_name;?> <?php echo Core::$word->AD_PANEL;?></span>
      ...
      <div class="screen-25 tablet-50 phone-100">
        <div class="wojo tertiary segment">
          <div class="columns">
            ...
            <div class="screen-70">
              <div class="wojo caps"><?php echo Core::$word->USER_B;?></div>
              <div class="wojo big font warning label"><?php echo countEntries(Users::uTable, "active", "b");?></div>
            </div>
          </div>
        </div>
      </div>
