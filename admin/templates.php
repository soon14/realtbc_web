...
<div class="wojo breadcrumb"> <i class="icon home"></i> <a href="index.php" class="section"><?php echo Core::$word->N_DASH;?></a>
  ...
  <div class="divider"></div>
  <div class="active section"><?php echo Core::$word->ET_SUBTITLE1;?></div>
</div>
<div class="wojo form basic segment">
  <div class="wojo header"><span><?php echo Core::$word->ET_SUBTITLE1;?></span><small><?php echo Core::$word->ET_SUBTITLE1 . ' [' . $row->name . ']';?></small>
